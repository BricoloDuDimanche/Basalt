...
import bot.bricolo.basalt.sources.MixcloudSourceManager
...
class MixcloudAudioTrack(trackInfo: AudioTrackInfo, private val sourceManager: MixcloudSourceManager) : DelegatedAudioTrack(trackInfo) {
